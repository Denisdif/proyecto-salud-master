        ...
        <!-- Cabecera -->
            <div class="card-header header-bg">
                <div class="card-title">
                    <p style="font-size:130%"> <i class="fa fa-id-card" aria-hidden="true"></i>Iluminación Insuficiente: Cuestionario Direccionado</p>
                </div>
            </div>
        <!-- / Cabecera -->
        <!-- Body -->
            <div class="card-body">
                <table id="tablaDetalle" style="border:1px solid black; width:100%" class="table table-bordered table-condensed table-hover">
                    <thead class="tableHeader-bg">
                        <tr>
                            <th width="10%" style="color:#F8F9F9" height="15px"><p class="text-uppercase" style="font-size:120%">Nro Cuestionario</p></th>
                    ...
                    <tbody>
                        @foreach ($iluminacionesDireccionados as $item)
