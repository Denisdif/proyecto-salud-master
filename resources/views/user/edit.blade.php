        ...
        <div class="card card-dark">
            <div class="card-header">
                <div class="card-title">
                    <p style="font-size:130%"> <i class="fa fa-key" aria-hidden="true"></i> Editar Cuenta de Usuario</p>
                </div>
            </div>
            <div class="card-body">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="form-group">
                        <select
                            ...
                            class="personal_clinica_id form-control">  
                                @foreach ($personals as $personal)
                                    @if ($personal->id == $user->personal_clinica_id)
                                        <option value="{{$personal->id}}" selected>{{$personal->documento . " " . $personal->nombreCompleto() }}</option> 
                                    @else
