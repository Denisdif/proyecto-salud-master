...
@section('navegacion')
    <li class="breadcrumb-item"><a href="/espiriometrias">Índice de Espiriometría</a></li>
    <li class="breadcrumb-item active">Formulario de Espiriometría</li>
@endsection
        ...
        <div class="card">
            <div class="card-header">
                <div class="card-title">
                    <p style="font-size:130%"> <i class="fas fa-stethoscope"></i> Formulario de Espiriometría</p>
                </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
